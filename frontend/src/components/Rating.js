export default function Rating(props) {
    ...
    return (
        <div className="rating">
            ...
            <span>
                <i className={rating >= 3 ? "fas fa-star" : rating >= 3.5 ? "fas fa-star-half-alt" : "far fa-star"}></i>
            </span>
            <span>
                <i className={rating >= 4 ? "fas fa-star" : rating >= 4.5 ? "fas fa-star-half-alt" : "far fa-star"}></i>
            </span>
            <span>
